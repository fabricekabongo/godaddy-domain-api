...
class ConsentNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === 'GoDaddy\\Domain\\Api\\Model\\Consent';
    }
    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && get_class($data) === 'GoDaddy\\Domain\\Api\\Model\\Consent';
    }
    public function denormalize($data, $class, $format = null, array $context = array())
    {
        ...
        $object = new \GoDaddy\Domain\Api\Model\Consent();
